...
public class TextFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        prevContent = (TextView) view.findViewById(R.id.previous_content);
        justRead = (TextView) view.findViewById(R.id.just_read);
        timeToWrite = (TextView) view.findViewById(R.id.time_to_write);
        justWritten = (TextView) view.findViewById(R.id.just_written);
        message = (TextView) view.findViewById(R.id.edit_message);
        btnWaitToWrite = (Button) view.findViewById(R.id.btn_wait_to_write);
        btnWrite800 = (Button) view.findViewById(R.id.btn_write_800);
